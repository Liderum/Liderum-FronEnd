...
import { Plus, Pencil, Trash2, Truck, RefreshCw, Building2, BarChart3 } from 'lucide-react';
    ...
    <div className="space-y-6 text-foreground">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="mt-1 text-muted-foreground">Gerencie os fornecedores cadastrados</p>
        </div>
