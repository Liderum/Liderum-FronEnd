    ...
    <div className="space-y-8">
      ...
      >
        <div className="flex items-center justify-center mb-4">
          ...
          <h1 className="text-4xl font-bold text-gray-900">
            Bem-vindo ao Liderum!
          </h1>
        </div>
        <p className="text-xl text-gray-600 max-w-2xl mx-auto">
          Olá <span className="font-semibold text-primary">{user?.name}</span>!
          Seu login foi realizado com sucesso. Escolha uma das opções abaixo
          para começar.
        </p>
      </motion.div>
      ...
      >
        <Card className="border-2 hover:border-primary/50 shadow-md">
          <CardHeader>
            ...
            <CardDescription>
              Conecte suas lojas online e gerencie todas as vendas em um só
              lugar
            </CardDescription>
          </CardHeader>
          <CardContent>
      ...
      >
        <p className="text-sm text-gray-500 mb-4">
          Precisa de ajuda? Consulte nossa documentação ou entre em contato com
          o suporte.
        </p>
