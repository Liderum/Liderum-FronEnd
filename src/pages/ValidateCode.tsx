...
.la-otp-digit{width:52px;height:60px;border:1px solid rgba(26,24,20,0.14);border-radius:10px;text-align:center;font-family:var(--font-numeric);font-size:26px;font-weight:600;font-variant-numeric:tabular-nums;color:var(--ink);background:var(--card-bg, #fff);outline:none;transition:border 0.2s,box-shadow 0.2s;}
